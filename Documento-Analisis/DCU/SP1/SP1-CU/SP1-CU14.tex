...
\begin{UseCase}{SP1-CU14}{Registrar autor de la bibliografía}{El usuario podrá registrar al autor de una bibliografía.}
        ...
        \UCitem{Postcondiciones}{
            \begin{itemize}
                ...
                \item El autor aparece en el catálogo que se le muestra al usuario en la \IUref{IU6}{Registrar bibliografía}.
            \end{itemize}}
        \UCitem{Errores}{}
...
\begin{UCtrayectoriaA}{A}{El usuario ya no requiere un nuevo autor.}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Cancelar} del modal \IUref{IU7}{Registrar autor de la bibliografía}.
    \UCpaso Cierra el modal.
    \UCpaso Continua en el paso 4 de la trayectoria principal del \UCref{SP1-CU14}.
\end{UCtrayectoriaA}
