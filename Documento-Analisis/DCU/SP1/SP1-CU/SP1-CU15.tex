%REGISTRAR PERFIL DOCENTE: AIKO.
\begin{UseCase}{SP1-CU15}{Registrar Perfil Docente}{El usuario podrá registrar el Perfil Docente correspondiente a una Unidad de Aprendizaje.}
    ...
    \UCitem{Postcondiciones}{El Perfil Docente queda registrado en el sistema.}
    \UCitem{Errores}{}
...
\begin{UCtrayectoriaA}{A}{El usuario desea cancelar el registro del Perfil Docente.}
...
\begin{UCtrayectoriaA}{A.1}{El usuario no desea cancelar el registro del Perfil Docente.}
