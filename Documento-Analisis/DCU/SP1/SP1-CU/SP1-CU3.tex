...
\begin{UseCase}{SP1-CU3}{Registrar la evaluación y acreditación de la UA}{El usuario podrá registrar la forma de evaluación con sus respectivos porcentajes y además podrá seleccionar la forma de acreditación de la UA.}
        ...
        \UCitem{Salidas}{
            \begin{itemize}
                ...
                \item MSG6. ¿Está seguro que desea cancelar el registro?
...
\begin{UCtrayectoriaA}{B}{No existe la forma de acreditación requerida en la lista de acreditaciones disponibles.}
    ...
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Registrar}. [Trayectoria B.1]
...
\begin{UCtrayectoriaA}{B.1}{El usuario presiona el botón ``Cerrar''.}
    ...
    \UCpaso[\UCactor] Confirma la operación presionando el botón \IUbutton{Si}. [Trayectoria B.1.1]
    \UCpaso Cierra el modal.
    \UCpaso Continua en el paso 4 de la trayectoria principal del \UCref{SP1-CU3}
\end{UCtrayectoriaA}

%------------------------ CU TRAYECTORIA ALTERNATIVA B.1.1 -------------------------

\begin{UCtrayectoriaA}{B.1.1}{El usuario presiona el botón ``Cerrar''.}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Cerrar}.
    \UCpaso Muestra el mensaje \MSGref{MSG6}{¿Está seguro que desea cancelar el registro?}
    \UCpaso[\UCactor] Confirma la operación presionando el botón \IUbutton{No}.
