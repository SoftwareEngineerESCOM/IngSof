...
\begin{UseCase}{SP2-CU1}{ Consultar contenido de propuesta de Unidad de Aprendizaje}{El usuario jefe de desarrollo e innovación curricular, analista y jefe de la división de innovación académica podrán consultar los contenidos de las unidades de aprendizaje de la unidad académica correspondiente.}
