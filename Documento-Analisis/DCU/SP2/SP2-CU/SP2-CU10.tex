\chapter{SP2-CU10 Autorizar Sección Bibliografía de Unidad de Aprendizaje }
\begin{UseCase}{SP2-CU10}{ Autorizar Sección Bibliografía de Unidad de Aprendizaje}{El analista podrá visualizar la información de la sección de Bibliografía de la unidad de aprendizaje para poder aprobarla.} 
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso El sistema verifica que la sección Bibliografía de la Unidad de Aprendizaje no haya sido aprobada anteriormente.\BRref{BR9}{Aprobación de Tareas Seccionadas.} \hyperlink{SP2-CU10-A1}{Trayectoria A1}. 
    ...
    \UCpaso	El sistema verifica que no existan nuevos comentarios o subrayados para la sección de la Unidad de Aprendizaje. \BRref{BR8}{Aprobación de Tareas.} \hyperlink{SP2-CU10-A3}{Trayectoria A3}. 
...
\begin{UCtrayectoriaA}{A1}{La sección de la Unidad de Aprendizaje ya ha sido aprobada anteriormente.}
	...
	\hypertarget{SP2-CU10-A1}{\UCpaso El sistema muestra la interfaz de usuario \IUref{SP2-IU-BIBLIOGRAFIA}{Sección Bibliografía}.}
