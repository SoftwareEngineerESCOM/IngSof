\begin{UseCase}{SP2-CU10}{ Autorizar Unidad Temática de Unidad de Aprendizaje}{El analista podrá visualizar la información de una Unidad Temática de la unidad de aprendizaje para poder aprobarla.} 
...
\begin{UCtrayectoria}{Principal}
	...
	\UCpaso El sistema muestra el nombre de las unidades temáticas en el menú de la interfaz  de usuario \IUref{SP2-IU-UT}{Unidades Temáticas}.
    ...
    \UCpaso El sistema verifica que la Unidad Temática   no haya sido aprobada anteriormente. \BRref{BR9}{Aprobación de Tareas Seccionadas.} \hyperlink{SP2-CU10-A1}{Trayectoria A1}. 
    ...
    \UCpaso[\UCactor] presiona el botón \IUbutton{Finalizar Revisión}. \hyperlink{SP2-CU10-A2}{Trayectoria A2}.
    \UCpaso El sistema muestra el \MSGref{MSG16}{¿Está seguro de Finalizar la Revisión?}.
    
    \UCpaso [\UCactor] presiona el botón \IUbutton{Aceptar}. \hyperlink{SP2-CU10-A4}{Trayectoria A4}.
    
    \UCpaso	El sistema verifica que no existan nuevos comentarios o subrayados para la Unidad Temática. \BRref{BR8}{Aprobación de Tareas.} \hyperlink{SP2-CU10-A3}{Trayectoria A3}. 
...
\begin{UCtrayectoriaA}{A1}{La sección de la Unidad de Aprendizaje ya ha sido aprobada anteriormente.}
	...
	\hypertarget{SP2-CU10-A1}{\UCpaso El sistema muestra la interfaz de usuario \IUref{SP2-IU-Unidad-Tematica}{Unidad Temática}.}
...
\begin{UCtrayectoriaA}{A2}{El analista no desea finalizar aun la revisión de la sección de la Unidad de Aprendizaje.}
    ...
    \hypertarget{SP2-CU10-A2}{\UCpaso[\UCactor] presiona el botón \IUbutton{Guardar} \hyperlink{SP2-CU10-A2.1}{Trayectoria A2.1}}. 
...
\begin{UCtrayectoriaA}{A2.1}{El analista desea cancelar todo lo que haya hecho en la sección de la Unidad de Aprendizaje durante esa sesión.}
	...
	\hypertarget{SP2-CU10-A2.1}{\UCpaso[\UCactor] presiona el botón \IUbutton{Cancelar}}. 
    ...
    \UCpaso [\UCactor] presiona el botón \IUbutton{Aceptar}. \hyperlink{SP2-CU10-A2.1.1}{Trayectoria A2.1.1}.
...
\begin{UCtrayectoriaA}{A2.1.1}{El analista no desea cancelar la revisión de la Unidad de Aprendizaje.} 
	...
	\hypertarget{SP2-CU10-A2.1.1}{\UCpaso[\UCactor] presiona el botón \IUbutton{Cancelar} del mensaje \MSGref{MSG15}{¿Está seguro que desea Cancelar la revisión? Se perderán las Anotaciones que no hayas guardado anteriormente.}}
...
\begin{UCtrayectoriaA}{A4}{El analista aun no desea finalizar la revisión de la Unidad de Aprendizaje.} 
	...
	\hypertarget{SP2-CU10-A4}{\UCpaso[\UCactor] presiona el botón \IUbutton{Cancelar} del mensaje \MSGref{MSG16}{¿Está seguro de Finalizar la Revisión?}}
    \UCpaso Regresa al paso 6 de la trayectoria principal. 
\end{UCtrayectoriaA}