\chapter{SP2-CU11 Autorizar Sección Perfil Docente de Unidad de Aprendizaje }
\begin{UseCase}{SP2-CU11}{ Autorizar Sección Perfil Docente de Unidad de Aprendizaje}{El analista podrá visualizar la información de la sección de Perfil Docente  de la unidad de aprendizaje para poder aprobarla.} 
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso El sistema verifica que la sección Perfil Docente de la Unidad de Aprendizaje no haya sido aprobada anteriormente. \BRref{BR9}{Aprobación de Tareas Seccionadas.} \hyperlink{SP2-CU11-A1}{Trayectoria A1}. 
    
    \UCpaso El sistema muestra la interfaz de usuario  \IUref{SP2-IU-Perfil-Docente}{Sección Perfil Docente}. 
    
    \UCpaso[\UCactor] presiona el botón \IUbutton{Finalizar Revisión}. \hyperlink{SP2-CU11-A2}{Trayectoria A2}.
    \UCpaso El sistema muestra el \MSGref{MSG16}{¿Está seguro de Finalizar la Revisión?}.
    
    \UCpaso	El sistema verifica que no existan nuevos comentarios o subrayados para la sección de la Unidad de Aprendizaje. \BRref{BR8}{Aprobación de Tareas.} \hyperlink{SP2-CU11-A3}{Trayectoria A3}. 
...
\begin{UCtrayectoriaA}{A1}{La sección de la Unidad de Aprendizaje ya ha sido aprobada anteriormente.}
	...
	\hypertarget{SP2-CU11-A1}{\UCpaso El sistema muestra la interfaz de usuario \IUref{SP2-IU-Perfil-Docente}{Sección Perfil Docente}.}
...
\begin{UCtrayectoriaA}{A2}{El analista no desea finalizar aun la revisión de la sección de la Unidad de Aprendizaje.}
    ...
    \hypertarget{SP2-CU11-A2}{\UCpaso[\UCactor] presiona el botón \IUbutton{Guardar} \hyperlink{SP2-CU11-A2.1}{Trayectoria A2.1}}. 
...
\begin{UCtrayectoriaA}{A2.1}{El analista desea cancelar todo lo que haya hecho en la sección de la Unidad de Aprendizaje durante esa sesión.}
	...
	\hypertarget{SP2-CU11-A2.1}{\UCpaso[\UCactor] presiona el botón \IUbutton{Cancelar}}. 
