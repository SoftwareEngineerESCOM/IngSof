...
\begin{UseCase}{SP2-CU2}{ Consultar paquetes de Unidad de Aprendizaje del Jefe de Innovación}{El usuario jefe de desarrollo e innovación curricular podrá consultar los paquetes que contienen las unidades de aprendizaje de la unidad académica corrrespondiente.}
		...
		\UCitem{Entradas}{Las para consultar un paquete de unidades de aprendizaje son:
          \begin{itemize}
		...
		\UCitem{Precondiciones}{ 
		   ...
		   \item Los paquetes deben ser enviados por la uniad académica correspondiente.
