\begin{UseCase}{SP2-CU8}{ Autorizar Sección Bibliografía de Unidad de Aprendizaje}{El analista podrá visualizar la información de la sección de Bibliografía de la unidad de aprendizaje para poder aprobarla.} 
		...
		\UCitem{Propósito}{Que el analista conozca la sección de Bibliografía de la propuesta de Unidad de Aprendizaje para determinar si necesita correcciones.}
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] presiona el botón  \IUbutton{Bibliografía} de la interfaz de usuario \IUref{SP2-IU-INICIO}{Sección Inicio}

    \UCpaso El sistema obtiene la información correspondiente a la sección de Bibliografía con base en el Modelo de Datos.
    ...
    \UCpaso El sistema verifica que la sección Bibliografía de la Unidad de Aprendizaje no haya sido aprobada anteriormente.\BRref{BR9}{Aprobación de Tareas Seccionadas.} \hyperlink{SP2-CU8-A1}{Trayectoria A1}. 
    
    \UCpaso El sistema muestra la interfaz de usuario  \IUref{SP2-IU-BIBLIOGRAFIA}{Sección Bibliografía}. 
    ...
    \UCpaso [\UCactor] presiona el botón \IUbutton{Aceptar}. \hyperlink{SP2-CU8-A4}{Trayectoria A4}.
...
\begin{UCtrayectoriaA}{A1}{La sección de la Unidad de Aprendizaje ya ha sido aprobada anteriormente.}
	...
	\hypertarget{SP2-CU8-A1}{\UCpaso El sistema muestra la interfaz de usuario \IUref{SP2-IU-BIBLIOGRAFIA}{Sección Bibliografía}.}
...
\begin{UCtrayectoriaA}{A2.1}{El analista desea cancelar todo lo que haya hecho en la sección de la Unidad de Aprendizaje durante esa sesión.}
    ...
    \UCpaso [\UCactor] presiona el botón \IUbutton{Aceptar}. \hyperlink{SP2-CU8-A2.1.1}{Trayectoria A2.1.1}.
...
\begin{UCtrayectoriaA}{A2.1.1}{El analista no desea cancelar la revisión de la Unidad de Aprendizaje.} 
	...
	\hypertarget{SP2-CU8-A2.1.1}{\UCpaso[\UCactor] presiona el botón \IUbutton{Cancelar} del mensaje \MSGref{MSG15}{¿Está seguro que desea Cancelar la revisión? Se perderán las Anotaciones que no hayas guardado anteriormente.}}
...
\begin{UCtrayectoriaA}{A3}{El analista realizo comentarios y subrayados para su posterior corrección en la sección de la Unidad de Aprendizaje.} 
	...
	\hypertarget{SP2-CU8-A3}{\UCpaso El sistema pone el estado de la sección Bibliografía de Unidad de Aprendizaje en “Revisado”.}
...
\begin{UCtrayectoriaA}{A4}{El analista aun no desea finalizar la revisión de la Unidad de Aprendizaje.} 
	...
	\hypertarget{SP2-CU8-A4}{\UCpaso[\UCactor] presiona el botón \IUbutton{Cancelar} del mensaje \MSGref{MSG16}{¿Está seguro de Finalizar la Revisión?}}
    \UCpaso Regresa al paso 6 de la trayectoria principal. 
\end{UCtrayectoriaA}