...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso El sistema verifica que la sección Evaluación y Acreditación de la Unidad de Aprendizaje no haya sido aprobada anteriormente.\BRref{BR9}{Aprobación de Tareas Seccionadas.} \hyperlink{SP2-CU9-A1}{Trayectoria A1}. 
