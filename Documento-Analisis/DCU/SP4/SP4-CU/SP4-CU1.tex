...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Ingresa el nombre del Programa Académico. Verifica que se cumpla la [Trayectoria C] el sistema verifica conforme al modelo de datos la \BRref{BR38}{Verificación de formularios al momento}.
