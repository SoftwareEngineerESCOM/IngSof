...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Verifica que se cumpla la \BRref{BR13}{Todos los campos son obligatorios} y \BRref{BR19}{El nombre del Programa Académico es único.}. [Trayectoria D][Trayectoria E]
