...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{(+)Registrar Programa Académico}de la interfaz de usuario \IUref{IU2.2-J}{Gestionar Programas Académicos}Existen las trayectorias alternativas [Trayectoria F] al presionar el boton Registrar.   
