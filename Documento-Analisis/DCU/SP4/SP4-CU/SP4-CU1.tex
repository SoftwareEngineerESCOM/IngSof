...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{(+)} que es Registrar Programa Académico de la interfaz de usuario \IUref{GPA-J}{Gestionar Programas Académicos}Existen las trayectorias alternativas [Trayectoria F] al presionar el boton Registrar.
    ...
    \UCpaso Persiste los datos ingresados.Accionando el boton \IUbutton{Registrar} se activa la  [Trayectoria G].
