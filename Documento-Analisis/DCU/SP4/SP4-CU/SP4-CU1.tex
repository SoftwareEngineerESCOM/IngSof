...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Registrar Programa Académico} de la interfaz de usuario \IUref{IU2.2}{Consultar Programas Académicos}
    ...
    \UCpaso Muestra la interfaz de usuario \IUref{IU2.2}{Consultar Programas Académicos}.
\end{UCtrayectoria}
