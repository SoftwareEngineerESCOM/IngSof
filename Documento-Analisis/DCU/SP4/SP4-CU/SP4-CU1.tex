...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Persiste los datos ingresados.Accionado por el boton \IUbutton{Registrar} [Trayectoria G].
...
\begin{UCtrayectoriaA}{A}{El actor presiona el botón \IUbutton{Cancelar}.}
    \UCpaso Muestra el mensaje \MSGref{MSG6}{¿Está seguro que desea cancelar el registro?}.
