...
\begin{UseCase}{SP4-CU1}{Registrar Programa Académico}{El Usuario inscribe los datos de un Programa Académico.}

		\UCitem{Versión}{\color{Gray}1.0}
		\UCitem{Autor}{\color{Gray}Plata García Josué Eliasaf}
		\UCitem{Supervisa}{\color{Gray}} 
		\UCitem{Actor}{\hyperlink{Usuario}{Jefe de Innovación Educativa}}
		\UCitem{Propósito}{Inscribir el nombre del Programa Académico.}
		...
		\UCitem{Postcondiciones}{El Programa Académico quedo registrado en el sistema.}
		\UCitem{Errores}{}
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Registrar Programa Académico} de la interfaz de usuario \IUref{IU2.2}{Página ConsultarProgramasAcadémicos}

    \UCpaso Muestra la interfaz de usuario \IUref{IU2.4.1}{Registrar Programa Académico}.
    ...
    \UCpaso Muestra la interfaz de usuario \IUref{IU2.2}{ConsultarProgramasAcadémicos}.
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}{C}{El actor presiona accidentalmente el botón Cancelar}
    ...
    \UCpaso Continua en el paso 4 de la trayectoria principal del \UCref{CU2.4.1}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{D}{Uno o más campos obligatorios no fueron contestados.}
    ...
    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
    \UCpaso Continua en el paso 3 de la trayectoria principal del \UCref{CU2.4.1}.
\end{UCtrayectoriaA}
