...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Verifica que todos los campos marcados como obligatorios hayan sido completamente contestados según la \BRref{BR13}{Todos los datos solicitados son obligatorios}. [Trayectoria D]
