...
\begin{UCtrayectoriaA}{F}{El Sistema detecta que algun campo no cumple con la expresión regular.}
	\UCpaso Muestra el mensaje \MSGref{MSG35}{Escribe información valida} debajo del campo que incumple la expresión regular estipulada en la \BRref{BR33}{Información de Plan de Estudios}.
	\UCpaso Continúa en el paso 4 de la trayectoria principal del \UCref{SP4-CU10}.
\end{UCtrayectoriaA}