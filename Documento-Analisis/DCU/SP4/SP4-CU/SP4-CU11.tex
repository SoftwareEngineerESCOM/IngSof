...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Modifica los campos deseados del Recurso Humano seleccionado, el sistema verifica conforme al diccionario de datos la \BRref{BR38}{Verificación de formularios al momento} [Trayectoria C].
