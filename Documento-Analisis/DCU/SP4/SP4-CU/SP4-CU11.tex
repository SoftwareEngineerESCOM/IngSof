...
\begin{UseCase}{SP4-CU11}{Editar Recurso Humano}{El usuario Jefe de Innovación Educativa modifica la información general de los usuarios}

		\UCitem{Versión}{\color{Gray}1.0}
		\UCitem{Autor}{\color{Gray}Plata García Josué Eliasaf}
		\UCitem{Supervisa}{\color{Gray}}
		\UCitem{Actor}{\hyperlink{Usuario}{Jefe de Innovación Educativa}}
		\UCitem{Propósito}{Cambiar los datos de un Recursho Humano.}
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Muestra la interfaz de usuario \IUref{IU2.4.1-J}{Registrar/Editar Recurso Humano}.
