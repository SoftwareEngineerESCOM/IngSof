\begin{UseCase}{SP4-CU11}{Editar Recurso Humano}{El usuario Jefe de Innovación Educativa modifica la información general del Recurso Humano.}
        ...
        \UCitem{Postcondiciones}{El Recurso Humano quedó actualizado en el sistema, permitiendo consultarlo agregarlo al pdf final.}
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Verifica que todos los campos marcados como obligatorios hayan sido contestados(Exceptuando los apellidos los cuales son opcionales) conforme a la \BRref{BR13}{Todos los datos solicitados son obligatorios},\BRref{BR36}{Estructura de Información Laboral.} y \BRref{BR35}{Estructura de Recursos Humanos.}[Trayectoria C][Trayectoria D].
...
\begin{UCtrayectoriaA}{D}{El Sistema detecta caracteres no alfanuméricos.}
    \UCpaso Muestra el mensaje \MSGref{MSG35}{ Escribe información valida} debajo del campo que incumplio con la \BRref{BR35}{Estructura de Recursos Humanos}.
    \UCpaso Continúa en el paso 4 de la trayectoria principal del \UCref{SP4-CU11}.
\end{UCtrayectoriaA}
