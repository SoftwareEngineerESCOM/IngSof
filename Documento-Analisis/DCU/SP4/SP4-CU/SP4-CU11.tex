...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Modifica los campos deseados, el sistema verifica conforme al diccionario de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR39}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria C][Trayectoria D]
