\begin{UseCase}{SP4-CU12}{Revisar Mapa Curricular}{Los usuarios Jefes y Analista visualizan los Contenidos de un Mapa Curricular y de ser necesario agregan comentarios.}
        ...
        \UCitem{Salidas}{
            \begin{itemize}
                \item MSG1. ¿Está seguro que desea finalizar?.
                \item MSG2. Revisión finalizada exitosamente.
                \item MSG3. Ocurrió un error, por favor inténtelo más tarde.
            \end{itemize}
        }
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Muestra el mensaje \MSGref{MSG1}{¿Está seguro que desea finalizar?.}.
    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Si}. [Trayectoria B]
    \UCpaso Muestra el mensaje \MSGref{MSG2}{Revisión finalizada exitosamente}.[Trayectoria C]
...
\begin{UCtrayectoriaA}{C}{El actor realizó comentarios}
    ...
    \UCpaso Muestra el mensaje \MSGref{MSG2}{Revisión finalizada exitosamente}.
    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
    \UCpaso Muestra la interfaz de usuario \IUref{IU2-D}{Consultar Tareas}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{C.1}{Ocurre un error al momento de persistir los datos}
    \UCpaso Muestra el mensaje \MSGref{MSG3}{Ocurrió un error, por favor inténtelo más tarde.}.
    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
    \UCpaso Muestra la interfaz de usuario \IUref{IU2-D}{Consultar Tareas}.
\end{UCtrayectoriaA}
