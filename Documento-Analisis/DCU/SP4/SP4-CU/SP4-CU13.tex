...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona sobre un Programa Académico en la Interfaz de usuario  \IUref{GPA-J}{Gestionar Programa Académico}.
    \UCpaso Muestra la interfaz de usuario \IUref{GPE-J}{Gestionar Planes de Estudios}.
    \UCpaso Muestra los Planes de Estudios del Programa Académico seleccionado.
\end{UCtrayectoria}