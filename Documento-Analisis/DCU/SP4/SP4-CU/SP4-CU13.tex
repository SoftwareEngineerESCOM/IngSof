...
\begin{UseCase}{SP4-CU13}{Consultar Planes de Estudios}{El usuario Docente visualiza la totalidad de los contenidos de los Planes de Estudios registrados.}
		...
		\UCitem{Salidas}{
        	\begin{itemize}
                \item MSG1. Los catálogos necesarios no están disponibles por el momento, favor de intentarlo más tarde.
        	\end{itemize}
        }
...
\begin{UCtrayectoriaA}{A}{El sistema no carga el catálogo de los Planes de Estudios.}
	...
	\UCpaso Muestra el mensaje \MSGref{MSG1}{.Los catálogos necesarios no están disponibles por el momento, favor de intentarlo más tarde. }
