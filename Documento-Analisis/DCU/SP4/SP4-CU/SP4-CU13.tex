...
\begin{UseCase}{SP4-CU13}{Consultar Planes de Estudios}{El usuario Jefe de Innovación Educativa visualiza los Planes de Estudios asociados a un mismo Programa Académico.}
		...
		\UCitem{Salidas}{
        	\begin{itemize}
                \item \MSGref{MSG38}{¿Está seguro que desea generar una nueva tarea para el registro de un nuevo Plan de Estudios?}
        	\end{itemize}
        }
...
\begin{UCtrayectoriaA}{A}{El actor presiona el botón  \IUbutton{+}.}
	\UCpaso Muestra el mensaje \MSGref{MSG38}{¿Está seguro que desea generar una tarea para el registro de un nuevo Plan de Estudios?}
