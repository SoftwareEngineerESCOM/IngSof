...
\begin{UseCase}{SP4-CU14}{Generar Tarea}{El usuario Jefe de Innovación Educativa registra nuevas Tareas en el sistema.}
...
\begin{UCtrayectoriaA}{B}{El actor selecciona como tipo de Tarea Registrar Unidad de Aprendizaje.}
    ...
    \UCpaso Continúa en el paso 8 de la trayectoria principal del \UCref{SP4-CU14}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{C}{El actor presiona accidentalmente el botón Cancelar}
    ...
    \UCpaso Continúa en el paso 10 de la trayectoria principal del \UCref{SP4-CU14}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{D}{Uno o más campos no fueron contestados.}
    ...
    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
    \UCpaso Continúa en el paso 6 de la trayectoria principal del \UCref{SP4-CU14}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{E}{La fecha que se ingresó es una fecha pasada.}
    ...
    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
    \UCpaso Continúa en el paso 9 de la trayectoria principal del \UCref{SP4-CU14}.
\end{UCtrayectoriaA}
