...
\begin{UseCase}{CU2}{Registrar Plan de Estudio}{El usuario Docente ingresa los datos del Plan de estudios, acorde a la entidad Plan de Estudios del Modelo de Dato.}
		...
		\UCitem{Salidas}{
        	\begin{itemize}
                ...
                \item MSG4 Los catálogos necesarios no estan disponibles por el momento, favor de intentarlo más tarde.
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Ingresa los créditos totales SATCAT del Plan de Estudios.
...
\begin{UCtrayectoriaA}{C}{El actor presiona accidentalmente el botón Cancelar}
	...
	\UCpaso Continua en el paso 8 de la trayectoria principal del \UCref{CU1}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{D}{Uno o más campos obligatorios no fueron contestados.}
	...
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
	\UCpaso Continua en el paso 2 de la trayectoria principal del \UCref{CU1}.
\end{UCtrayectoriaA}
