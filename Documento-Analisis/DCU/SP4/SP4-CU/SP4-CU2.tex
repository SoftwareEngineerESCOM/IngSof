...
\begin{UCtrayectoria}{Principal}
	...
	\UCpaso[\UCactor] Ingresa el año del Plan de Estudios, el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
	...
	\UCpaso[\UCactor] Ingresa los créditos totales SATCA del Plan de Estudios, el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
	\UCpaso[\UCactor] Ingresa Total horas / Teoría del Plan de Estudios, el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
	\UCpaso[\UCactor] Ingresa Total horas / Práctica del Plan de Estudios, el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
