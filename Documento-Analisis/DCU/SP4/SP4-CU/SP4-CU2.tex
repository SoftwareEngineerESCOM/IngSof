...
\begin{UCtrayectoria}{Principal}
	...
	%Sistema
	\UCpaso  El sistema verifica la existencia de registros en el catálogo modalidad y en el de programa académico de la \BRref{BR14}{Existen los catálogos}.
    \UCpaso El sistema carga los catálogos: modalidad y programa académico .[Trayectoria A]
    ...
    \UCpaso Verifica que se cumpla la \BRref{BR13}{Todos los campos son obligatorios}. [Trayectoria E]
