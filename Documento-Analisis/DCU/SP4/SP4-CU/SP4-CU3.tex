...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Ingresa el nombre de la Unidad de Aprendizaje según la \BRref{BR17}{El nombre de la Unidad Académica es único},la \BRref{BR18}{Longitud Maxima de Unidad de Aprendizaje} y el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C] [Trayectoria F]
    \UCpaso Los créditos totales TEPIC del Plan de Estudios son obtenidos mediante la \BRref{BR36}{Calculos de créditos TEPIC}.
    \UCpaso[\UCactor] Ingresa los créditos SATCA de la Unidad de Aprendizaje, y el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
    \UCpaso[\UCactor] Ingresa las horas de teorías por semana de la Unidad de Aprendizaje, y el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
    \UCpaso[\UCactor] Ingresa las horas de prácticas por semana de la Unidad de Aprendizaje, y el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR13}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C]
