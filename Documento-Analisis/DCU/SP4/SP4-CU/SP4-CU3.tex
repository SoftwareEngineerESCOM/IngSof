...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{+} de la interfaz de usuario \IUref{IU2.1-D}{Consultar Mapa Curricular}.
...
\begin{UCtrayectoriaA}{E}{La base de datos no está disponible, o hubo un error de conexión.}
	...
	\UCpaso El sistema regresa a la interfaz de usuario\IUref{IU2.1.2-D}{Registrar Unidad de Aprendizaje}
\end{UCtrayectoriaA}