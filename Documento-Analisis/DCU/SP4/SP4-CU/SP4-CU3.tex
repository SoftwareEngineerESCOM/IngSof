...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Ingresa el nombre de la Unidad de Aprendizaje según la \BRref{BR17}{El nombre de la Unidad Académica es único},la \BRref{BR18}{Longitud Maxima de Unidad de Aprendizaje} y el sistema verifica conforme al modelo de datos, la \BRref{BR38}{Verificación de formularios al momento} y la \BRref{BR39}{Todos los campos marcados con (*) son obligatorios}.[Trayectoria D][Trayectoria C] [Trayectoria F]
