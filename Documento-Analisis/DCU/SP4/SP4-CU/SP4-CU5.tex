...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Selecciona la Unidad Académica que desee como filtro. [Trayectoria B] Trayectoria Lanzada por el botón filtro y [Trayectoria C] al verificar la \BRref{BR40}{BR40}{El Jefe de Innovación Educativa solo hace operaciones dentro del Sistema que esten dentro de su Unidad Académica.}
