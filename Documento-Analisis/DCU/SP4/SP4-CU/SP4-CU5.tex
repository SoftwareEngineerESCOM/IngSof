\begin{UseCase}{SP4-CU5}{Consultar Programas Académicos}{El usuario Jefe de Innovación Educativa visualiza la información de los Programas Académicos regsitrados.}
		...
		\UCitem{Precondiciones}{\begin{itemize}
                \item El catálogo de tipo Programa Académico debe de estar cargado en el sistema.
                   \end{itemize}}
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Muestra la interfaz de usuario \IUref{CPA-J}{Gestionar Programa Académico}.
