...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Carga el catálogo de Lugar de Trabajo descrito en la \BRref{BR14}{Catálogos existentes} [Trayectoria A] [Trayectoria C]
...
\begin{UCtrayectoriaA}{C}{El actor es el Jefe de Innovación Educativa}
    \UCpaso Continúa en el paso 5 de la trayectoria principal del \UCref{SP4-CU5} con filtro predeterminado de su Unidad Académica.
\end{UCtrayectoriaA}
