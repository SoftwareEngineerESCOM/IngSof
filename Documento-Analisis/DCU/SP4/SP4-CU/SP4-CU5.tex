...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Gestionar Programa Académico} del menú de la interfaz de usuario del Jefe de Innovación Educativa.Existen las trayectorias alternativas [Trayectoria D] al presionar el boton Gestionar Programa Académico.
