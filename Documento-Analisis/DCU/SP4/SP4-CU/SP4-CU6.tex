...
\begin{UseCase}{SP4-CU6}{Consultar Mapa Curricular}{El usuario Docente visualiza la totalidad de los contenidos del Mapa Curricular registrados.}
		...
		\UCitem{Salidas}{
        	\begin{itemize}
        		\item \MSGref{MSG36}{¿Está seguro que desea eliminar la Unidad de Aprendizaje [Nombre de la UNidad de Aprendizaje]?}.
...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón Consulta de la Interfaz de usuario  \IUref{IU2-D}{Consultar Tareas}.
...
\begin{UCtrayectoriaA}{C}{El usuario presiona el botón \IUbutton{X} de una Unidad de Aprendizaje.}
    ...
    \UCpaso Continúa la trayectoria principal del \UCref{SP4-CU6} desde el paso 4.
\end{UCtrayectoriaA}
