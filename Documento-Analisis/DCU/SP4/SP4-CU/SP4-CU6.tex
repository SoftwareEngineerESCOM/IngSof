...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Selecciona el semestre de la Unidades de Aprendizaje que desea consultar.[Trayectoria A][Trayectoria B][Trayectoria B.1][Trayectoria F]
...
\begin{UCtrayectoriaA}{E}{El usuario desea eliminar un semestre con unidades de Aprendizaje}
	...
	\UCpaso Muestra el mensaje \MSGref{MSG32}{El semestre no se puede eliminar debido a que contiene unidades de aprendizaje.}
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
	\UCpaso Continúa en el paso 4 de la trayectoria principal del \UCref{SP4-CU6}.
\end{UCtrayectoriaA}

%------------------------ CU TRAYECTORIA ALTERNARIVA F -------------------------
\begin{UCtrayectoriaA}{F}{El usuario presiona accidentalmente el botón \IUbutton{Lápiz} de Rediseñar}
...
\begin{UCtrayectoriaA}{F.1}{El usuario presiona el botón \IUbutton{Lápiz} de Rediseñar}
	\UCpaso  Muestra el mensaje \MSGref{MSG53}{¿Está seguro que desea rediseñar el plan de estudios? (Se hara una copia de este)}.
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Si}.
	\UCpaso Continúa en el paso 3 de la trayectoria principal del \UCref{SP4-CU6}.
\end{UCtrayectoriaA}
