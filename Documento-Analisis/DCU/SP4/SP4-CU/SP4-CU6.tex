...
\begin{UseCase}{SP4-CU6}{El usuario Docente visualiza la totalidad de los contenidos del Mapa Curricular registrados.}
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] si lo desea, selecciona la opción de editar del Plan de Estudios.[Trayectoria B].
    \UCpaso[\UCactor] Selecciona el semestre de la Unidades de Aprendizaje que desea consultar.
    \UCpaso Muestra las Unidades de Aprendizaje registradas en el sistema.

    \UCpaso si lo desea, selecciona la opción de editar Unidad de Aprendizaje. [Trayectoria C]
    
     \UCpaso si lo desea, selecciona la opción de eliminar Unidad de Aprendizaje. [Trayectoria D]
...
\begin{UCtrayectoriaA}{B}{El usuario desea modificar el Plan de Estudios.}
	\UCpaso Realiza la trayectoria principal del \UCref{SP4-CU10}
...
\begin{UCtrayectoriaA}{C}{El usuario desea modificar la Unidad de Aprendizaje.}
	\UCpaso Realiza la trayectoria principal del \UCref{SP4-CU9}
	\UCpaso Continúa en el paso 8 de la trayectoria principal del \UCref{SP4-CU6}.
\end{UCtrayectoriaA}
...
%------------------------ CU TRAYECTORIA ALTERNARIVA D.2 -------------------------
