...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Muestra tabla con los datos de los Recursos Humanos que cumplan con el filtro seleccionado.[Trayectoria B][Trayectoria B.1][Trayectoria C][Trayectoria C.1]
\end{UCtrayectoria}
