...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Muestra una tabla con los datos de todos los Recursos Humanos que cumplan con el filtro.[Trayectoria B][Trayectoria C][Trayectoria C.1]
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}{B}{El actor selecciona un Cargo como filtro}
    \UCpaso[\UCactor] Selecciona Cargo como filtro.
