...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso Verifica que se cumplan la \BRref{BR13}{Todos los datos solicitados son obligatorios} y la \BRref{BR19}{El nombre del Programa Académico es único.} [Trayectoria B][Trayectoria D]
