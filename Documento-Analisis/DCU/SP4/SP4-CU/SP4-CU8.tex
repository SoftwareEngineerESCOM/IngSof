...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{lápiz} de la interfaz de usuario \IUref{GPA-J}{Gestionar Programas Académicos}. Existen las trayectorias alternativas [Trayectoria E] al presionar el botón \IUbutton{lápiz}.
