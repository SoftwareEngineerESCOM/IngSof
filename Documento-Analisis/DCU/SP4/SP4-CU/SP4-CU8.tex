...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Editar} de la interfaz de usuario \IUref{GPA-J}{Gestionar Programas Académicos} el cual tiene forma de lápiz. Existen las trayectorias alternativas [Trayectoria F] al presionar el botón Editar.
    ...
    \UCpaso[\UCactor] Termina la operación presionando el botón \IUbutton{Finalizar}. Existen las trayectorias alternativas [Trayectoria A] y [Trayectoria B] al presionar el botón Cancelar.
    ...
    \UCpaso Persiste los datos ingresados.Accionandoel botón \IUbutton{Finalizar} se activa la  [Trayectoria G].
