...
\begin{UCtrayectoria}{Principal}
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Editar} de la interfaz de usuario \IUref{CPA-J}{Consultar Programas Académicos} el cual tiene forma de lápiz. Existen las trayectorias alternativas [Trayectoria F] al presionar el boton Editar.

    \UCpaso Muestra la interfaz de usuario \IUref{RPA-J}{Editar Programa Académico}.
    ...
    \UCpaso Persiste los datos ingresados.Accionado por el boton \IUbutton{Finalizar} [Trayectoria G]

    \UCpaso El sistema muestra el mensaje \MSGref{MSG31}{Los cambios se guardaron exitosamente.}

    \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.

    \UCpaso Muestra la interfaz de usuario \IUref{CPA-J}{Consultar Programas Académicos}.
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}{A}{El actor presiona el botón \IUbutton{Cancelar}.}
    ...
    \UCpaso Muestra la interfaz de usuario \IUref{CPA-J}{Gestionar Programas Académicos}
\end{UCtrayectoriaA}
