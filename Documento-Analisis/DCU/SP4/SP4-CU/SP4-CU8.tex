...
\begin{UCtrayectoriaA}{D}{El Sistema detecta que el Nombre de Programa Académico no cumple con la expresión regular}
    \UCpaso Muestra el mensaje \MSGref{MSG35}{Escribe información valida} debajo del campo que incumplió la expresión regular estipulada en la \BRref{BR31}{Información de Programa Académico}.
...
\begin{UCtrayectoriaA}{H}{El Sistema detecta que el Nombre de Programa Académico excede la longitud máxima}
    \UCpaso No permite que se escriba un longitud mayor que la expesificada en la \BRref{BR32}{Longitud máxima de nombre de Programa Académico}.
    \UCpaso Continúa en el paso 4 de la trayectoria principal del \UCref{SP4-CU8}.
\end{UCtrayectoriaA}