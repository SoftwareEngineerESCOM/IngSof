...
\begin{UseCase}{SP5-CU1}{Iniciar sesión}{Los diversos usuarios podrán ingresar al sistema.}
        ...
        \UCitem{Salidas}{
            \begin{itemize}
                \item Página principal del sistema según la \BRref{BR37}{Dirección web del sistema}.
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Ingresa el url en el navegador establecido en la \BRref{BR37}{Dirección web del sistema}. [Trayectoria A] 
    \UCpaso Muestra la interfaz de usuario \IUref{IU3}{Inicio de sesion}.
    \UCpaso[\UCactor] Ingresa su correo electrónico, el sistema verifica la consistencia de la información conforme al diccionario de datos, y la \BRref{BR38}{Verificación de formularios al momento}. [Trayectoria G]
    \UCpaso[\UCactor] Ingresa su contraseña, el sistema verifica la consistencia de la información conforme al diccionario de datos, y la \BRref{BR38}{Verificación de formularios al momento}. [Trayectoria G]
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Entrar} de la interfaz de usuario \IUref{IU3}{Inicio de sesión}[Trayectoria A] [Trayectoria B] [Trayectoria C] [Trayectoria D] [Trayectoria E] [Trayectoria F].
...
\begin{UCtrayectoriaA}{G}{Inconsistencias con el diccionario de datos.}
        ...
        \UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
        \UCpaso Continúa en la interfaz de usuario \IUref{IU3}{Inicio de sesion}.
    \end{UCtrayectoriaA}
