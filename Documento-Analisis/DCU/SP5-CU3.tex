...
\begin{UCtrayectoria}{Principal}
	...
	\UCpaso[\UCactor] Selecciona el cargo de los empleados a buscar. [Trayectoria C] [Trayectoria E] 
	\UCpaso El sistema despliega la información de los usuarios (matricula,  nombre, primer apellido, segundo apellido, titulo, cargo, lugar de trabajo) en la parte inferior de la pantalla \IUref{IU2}{Gestionar usuarios}. [Trayectoria Principal punto 4] [Trayectoria D] [Trayectoria F] 
\end{UCtrayectoria}
