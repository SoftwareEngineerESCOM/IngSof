...
\begin{UCtrayectoriaA}{E}{El actor es el JIE.}
 \UCpaso El sistema despliega la información  de los empleados permitidos para el JIE de acuerdo a la BR3 (cargo, nombre, matricula, titulo, lugar de trabajo) en la parte inferior de la pantalla \IUref{IU2}{Gestionar empleados}.[Trayectoria F]
 \UCpaso Continua en el paso 2 de la trayectoria principal del \UCref{SP5-CU3}.
\end{UCtrayectoriaA}
