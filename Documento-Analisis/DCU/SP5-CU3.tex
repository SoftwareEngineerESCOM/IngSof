...
\begin{UCtrayectoriaA}{D}{El actor presiona el botón \IUbutton{X}.}
	\UCpaso El sistema muestra el mensaje \MSGref{MSG22}{¿Seguro de eliminar al empleado: ''Nombre'' con correo: ''Correo'' del sistema?} solicitando confirmación. [Trayectoria D1]
