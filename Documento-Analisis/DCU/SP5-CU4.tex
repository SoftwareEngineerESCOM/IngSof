...
\begin{UCtrayectoria}{Principal.}
	...
	\UCpaso  El sistema verifica la existencia de registros en los catálogos cargos  y  lugares de trabajo de la \BRref{BR14}{Catálogos del Sistema} . [Trayectoria B] 
	...
	\UCpaso[\UCactor] Captura la información necesaria del empleado según la \BRref{BR30}{Información personal de usuarios y/o recursos humanos} y la \BRref{BR35}{Información laboral de los usuarios y recursos humanos}.[Trayectoria C] [Trayectoria D] 
...
\begin{UCtrayectoriaA}{B}{No existen registros en los catálogos.}
	\UCpaso El sistema muestra el mensaje \MSGref{MSG7}{Los catálogos necesarios no se han cargado, favor de intentarlo más tarde.}.
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{D}{El actor presiono el botón \IUbutton{Cancelar}.}
	...
	\UCpaso[\UCactor] Cierra el mensaje presionando el boton \IUbutton{Aceptar}. [Trayectoria K]
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{F}{Se incumple la \BRref{BR3}{Gestión de Usuarios} o la \BRref{BR4}{Cada Usuario debe estar relacionado a una zona de trabajo}  o la \BRref{BR30}{Información personal de usuarios y/o recursos humanos} o la \BRref{BR35}{Información laboral de los usuarios y recursos humanos} en la definición de cada campo.}
...
\begin{UCtrayectoriaA}{H}{La base de datos no está disponible, o hubo un error de conexión.}
	\UCpaso El sistema muestra el mensaje \MSGref{MSG25}{Servicios no disponibles por el momento. Error: ''Número de error''}.
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{I}{El sistema no encuentra la interfaz a mostrar.}
	...
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
\begin{UCtrayectoriaA}{J}{Uno o mas campos de la \BRref{BR30}{Información personal de usuarios y/o recursos humanos} o la \BRref{BR35}{Información laboral de los usuarios y recursos humanos} están vacíos.}
	\UCpaso El sistema muestra el \MSGref{MSG44}{Este campo es requerido} debajo de cada campo que no fue llenado. 
	\UCpaso	Continúa en el paso 5 de la trayectoria principal del \UCref{SP5-CU4}.
\end{UCtrayectoriaA}
\begin{UCtrayectoriaA}{K}{El actor presiono el botón \IUbutton{Cancelar}.}
