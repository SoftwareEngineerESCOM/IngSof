...
\begin{UCtrayectoriaA}{B}{No existen registros en los catálogos.}
	...
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
	\UCpaso El sistema muestra la interfaz de usuario  \IUref{IU8}{Registrar empleados}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{I}{El sistema no encuentra la interfaz a mostrar.}
	...
	\UCpaso El sistema muestra el \MSGref{MSG25}{Servicios no disponibles por el momento.}
	\UCpaso[\UCactor] Cierra el mensaje presionando el botón \IUbutton{Aceptar}.
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
