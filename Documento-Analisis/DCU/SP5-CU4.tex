...
\begin{UCtrayectoria}{Principal.}
	...
	\UCpaso[\UCactor] Captura la información necesaria del empleado según la \BRref{BR30}{Información personal de los usuarios} y la \BRref{BR34}{Información laboral de los usuarios}.[Trayectoria C] [Trayectoria D] 
...
\begin{UCtrayectoriaA}{F}{Se incumple la \BRref{BR3}{Gestión de Usuarios} o la \BRref{BR4}{Cada Usuario debe estar relacionado a una zona de trabajo}  o la \BRref{BR30}{Información personal de los usuarios} o la \BRref{BR34}{Información laboral de los usuarios} en la definición de cada campo.}
...
\begin{UCtrayectoriaA}{I}{El sistema no encuentra la interfaz a mostrar.}
	...
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
\begin{UCtrayectoriaA}{J}{Uno o mas campos de la \BRref{BR30}{Información personal de los usuarios} o la \BRref{BR34}{Información laboral de los usuarios} están vacíos.}
	\UCpaso El sistema muestra el \MSGref{MSG44}{El campo es requerido} debajo de cada campo que no fue llenado. 
	\UCpaso	Continúa en el paso 5 de la trayectoria principal del \UCref{SP5-CU4}.
\end{UCtrayectoriaA}
