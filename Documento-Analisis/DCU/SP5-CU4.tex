...
\begin{UCtrayectoria}{Principal.}
	...
	\UCpaso[\UCactor] Captura la información necesaria del empleado según la \BRref{BR30}{Información de los usuarios} .[Trayectoria C] [Trayectoria D] 
...
\begin{UCtrayectoriaA}{F}{Se incumple la \BRref{BR3}{Gestión de Usuarios} o la \BRref{BR4}{Cada Usuario debe estar relacionado a una zona de trabajo}  o la  \BRref{BR30}{Información de los usuarios} en la definición de cada campo   .}
