...
\begin{UCtrayectoriaA}{I}{El sistema no encuentra la interfaz a mostrar.}
	...
	\UCpaso El sistema regresa a la interfaz de usuario \IUref{IU2}{Gestionar empleados}.
\end{UCtrayectoriaA}
\begin{UCtrayectoriaA}{J}{Uno o mas campos de la {BR30}{Información personal de los usuarios} o la \BRref{BR34}{Información laboral de los usuarios} están vacíos.}
