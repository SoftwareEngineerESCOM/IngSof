...
\begin{UseCase}{SP5-CU4}{Registrar Usuario.}{El \hyperlink{JDIC}{JDIC}, \hyperlink{JDIA}{JDIA} y  \hyperlink{JUA}{JUA} podrán crear las cuentas de los empleados que están a su cargo. }
        ...
        \UCitem{Salidas}{
            \begin{itemize}
            \item \label{MSG27} MSG7. Los catálogos necesarios no se han cargado, favor de intentarlo más tarde.
            \item \label{MSG25} MSG25. Servicios no disponibles por el momento.
                \item \label{MSG29} MSG29. El usuario se ha registrado exitosamente.
                \item \label{MSG30} MSG30. Error, el usuario ya existe en el sistema. 
                \item \label{MSG31} MSG31. Inconsistencia en los datos. Verifique los campos e intente de nuevo.
                \item \label{MSG31} MSG32. No existen recursos humanos registrados en el sistema con la matrícula ingresada.
            \end{itemize}
        }
