...
\begin{UCtrayectoriaA}{B}{No existen registros en los catálogos.}
	...
	\UCpaso El sistema muestra la interfaz de usuario \IUref{IU7}{Editar empleados}.
\end{UCtrayectoriaA}
...
\end{UCtrayectoriaA}
\begin{UCtrayectoriaA}{I}{Uno o mas campos de la \BRref{BR30}{Información personal de usuarios y/o recursos humanos} o la \BRref{BR35}{Información laboral de los usuarios y recursos humanos} están vacíos.}
