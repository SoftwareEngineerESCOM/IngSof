...
\begin{UCtrayectoriaA}{E}{Se incumple la \BRref{BR3}{Gestión de Usuarios} o la  \BRref{BR30}{Información de los usuarios} o la \BRref{BR4}{Cada Usuario debe estar relacionado a una zona de trabajo.}  .}
