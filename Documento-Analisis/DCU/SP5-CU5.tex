...
\begin{UCtrayectoriaA}{E}{Se incumple la \BRref{BR3}{Gestión de Usuarios} o la \BRref{BR4}{Cada Usuario debe estar relacionado a una zona de trabajo}  o la  \BRref{BR30}{Información personal de los usuarios} o la \BRref{BR34}{Información laboral de los usuarios} en la definición de cada campo.}
...
\end{UCtrayectoriaA}
\begin{UCtrayectoriaA}{I}{Uno o mas campos de la \BRref{BR30}{Información personal de los usuarios} o la \BRref{BR34}{Información laboral de los usuarios} están vacíos.}
