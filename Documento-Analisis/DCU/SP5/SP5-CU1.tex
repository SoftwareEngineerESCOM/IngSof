...
\begin{UCtrayectoriaA}{A}{La página no se encuentra disponible.}
    ...
    \UCpaso El sistema muestra el mensaje \MSGref{MSG6}{Por el momento no esta disponible}.
\end{UCtrayectoriaA}

%------------------------ CU TRAYECTORIA ALTERNARIVA B -------------------------

\begin{UCtrayectoriaA}{B}{La matrícula y/o contraseña son incorrectas.}
    \UCpaso El sistema muestra el mensaje \MSGref{MSG1}{Matrícula y/o contraseña no validas.}
