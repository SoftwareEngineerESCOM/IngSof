...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Ingresa su matrícula con base en la regla \BRref{BR27}{Longitud máxima de matricula} y \BRref{BR29}{Matricula unica para cada Usuario o Recurso Humano} 
    \UCpaso[\UCactor] Ingresa su contraseña con base en la regla \BRref{BR28}{Longitud máxima de contraseña}.
