...
\begin{BussinesRule}{BR33}{Información del Plan de Estudio.}
	...
	\begin{itemize}
		...
		\item Total Horas/ Teoría. Expresión Regular: [1-9]\{3\}
		\item Total Horas/ Práctica. Expresión Regular: [1-9]\{3\}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Total Horas/ Teoría: 160
		\item Total Horas/ Práctica: 250
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Total Horas/ Teoría: 10.4
		\item Total Horas/ Práctica: 56.8
	\end{itemize}
\end{BussinesRule}
%----------------------------------BR --------------------------------------%
\begin{BussinesRule}{BR34}{Información de Unidad de Aprendizaje.}
	...
	\begin{itemize}
		...
		\item Horas Teoría/Semana: 20
		\item Horas Práctica/Semana:10
	\end{itemize}
	\BRitem[Ejemplo negativo:] Información del Plan de Estudios
	\begin{itemize}
		...
		\item Horas Teoría/Semana: 20.34
		\item Horas Práctica/Semana:10.56
	\end{itemize}
\end{BussinesRule}
%----------------------------------BR --------------------------------------%
