...
\begin{BussinesRule}{BR35}{Información laboral de los usuarios y recursos humanos.}
 ...
 %----------------------------------BR --------------------------------------%
   \begin{BussinesRule}{BR37}{Dirección web del sistema.}
     ...
     \BRitem[Clase:] Habilitadora.
     \BRitem[Nivel:] Control.
     \BRitem[Descripción:] La dirección web a la cual tendrán que ingresar los actores en el navegador para acceder al sistema es la siguiente: \url{https://apms-ipn.herokuapp.com/}
