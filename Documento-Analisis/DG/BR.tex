...
\begin{BussinesRule}{BR}{Aprobación de Tareas Seccionada}
...
\begin{BussinesRule}{BR}{Asignar tareas.}
...
\begin{BussinesRule}{BR}{Tiempos de entregas.}
...
\begin{BussinesRule}{BR}{Todos los datos solicitados son obligatorios.}
...
\begin{BussinesRule}{BR}{ Longitud máxima de Unidad de aprendizaje.}
    \BRitem[Tipo: Regla de inferencia de un hecho]
    \BRitem[Clase: Habilitadora]
    \BRitem[Nivel: Control]
...
\begin{BussinesRule}{BR}{Las horas totales deben de estar entre 350 y 450 horas.}
    \BRitem[Tipo: Regla de operación]
    \BRitem[Clase: Habilitadora]
    \BRitem[Nivel: Control]
