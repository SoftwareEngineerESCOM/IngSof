...
\end{BussinesRule}
%----------------------------------BR --------------------------------------%
\begin{BussinesRule}{BR40}{El Jefe de Innovación Educativa solo hace operaciones dentro del Sistema que sean parte de su Unidad Académica.}
    \BRitem[Tipo:] Regla de Operación.
    \BRitem[Clase:] Habilitadora.
    \BRitem[Nivel:] Control.
    \BRitem[Descripción:] El Jefe de Innovación Educativa tienen el filtro predeterminado de su Unidad Académica para cualquier actividad dentro del Sistema.
    \BRitem[Sentencia:]
    \BRitem[Motivación: ]Permitir que cada Unidad Académica trabaje de forma autonoma e independiente a las demas.
