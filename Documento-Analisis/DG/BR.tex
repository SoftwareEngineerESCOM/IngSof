...
\begin{BussinesRule}{BR3}{Gestión de Usuarios}
    ...
    \BRitem[Descripción:  Solo los Jefes pueden registrar, consultar, modificar y eliminar los datos de los usuarios que estén a su cargo, la organización sera la siguiente:
...
Jefe de División de Innovación Académica:DES.
Jefe de Departamento de Desarrollo e Innovación curricular: DES.
Jefe de Innovación Educativa: Unidad Académica .
Docente: Unidad Académica donde pertenezca el usuario que lo creo.
Analista: Donde pertenezca el usuario que lo creo.]
