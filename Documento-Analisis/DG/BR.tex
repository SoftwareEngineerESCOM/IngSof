...
\begin{BussinesRule}{BR30}{Información personal de los usuarios.}
    ...
    \begin{itemize}
        ...
        \item Contraseña. Expresión regular: [\^{}áéíóúüñÁÉÍÓÚÜÑ\textbackslash{}s]+
        \item Correo electrónico.    
    \end{itemize} 
    \BRitem[Motivación:] Contar con la información necesaria de los usarios para el desarrollo de las actividades.
    \BRitem[Ejemplo positivo:] Información personal del usuario 
    \begin{itemize}
    ...
    \end{itemize}
    \BRitem[Ejemplo negativo:] Información personal del usuario 
    \begin{itemize}
...
\begin{BussinesRule}{BR31}{Información de Programa Académico.}
    ...
    \begin{itemize}
        ...
        [\textbackslash{}wéíóúüñÁÉÍÓÚÜÑ]+([\textbackslash{}wáéíóúüñÁÉÍÓÚÜÑ]+)*
...
\begin{BussinesRule}{BR33}{Información laboral de los usuarios.}
    \BRitem[Tipo:] Regla de integridad.
    \BRitem[Clase:] Habilitadora.
    \BRitem[Nivel:] Control.
    \BRitem[Descripción:] Cada usuario debe tener asignado:
    \begin{itemize}
    ...
    \BRitem[Motivación:] Contar con la información laboral necesaria de los usarios para el desarrollo de las actividades.
    \BRitem[Ejemplo positivo:] Información laboral del usuario 
    \begin{itemize}
        \item Título: Doctor
    ...
    \end{itemize}
    \BRitem[Ejemplo negativo:] Información laboral del usuario 
    \begin{itemize}
