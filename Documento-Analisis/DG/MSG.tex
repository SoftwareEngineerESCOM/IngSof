...
% -------- INCLUIDO POR : Naibi
\MSGdes{MSG41}{Debe llenar el Programa Sintético para realizar este registro}{Esta es la descripción.}

\MSGdes{MSG42}{Fecha invalida.}

\MSGdes{MSG43}{El nombre del Programa Académico ya está registrado porfavor cámbielo.}{Esta es la descripción.}
