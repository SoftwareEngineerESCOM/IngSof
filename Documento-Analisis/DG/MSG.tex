...
\subsection{MSG28. El autor: "Nombre Primer Apellido Segundo Apellido" ya existe.}
    ...
    % -------- INCLUIDO POR : Arturo
    \subsection{MSG30. ¿Está seguro que desea finalizar? Ya no podrá realizar modificaciones.}
    ...
    % -------- INCLUIDO POR : Arturo
    \subsection{MSG32. Todos los campos son obligatorios}
        %Descripción del mensaje, cuándo aparece y en que IU se muestra
        %Cómo se cierra ese msj
        % Imagen del msj
        % Se han editado los datos de un empleado
    ...
    % -------- INCLUIDO POR : Arturo
    \subsection{MSG33. El Recurso Humano con la Matrícula de Empleado [Número de Matrícula de Empleado] ya existe.}
        %Descripción del mensaje, cuándo aparece y en que IU se muestra
        %Cómo se cierra ese msj
        % Imagen del msj
        % Se han editado los datos de un empleado
    ...
    % -------- INCLUIDO POR : Arturo
    \subsection{MSG34. ¿Está seguro que desea Eliminar al Usuario con Matricula [no.matricula]?}
        %Descripción del mensaje, cuándo aparece y en que IU se muestra
        %Cómo se cierra ese msj
        % Imagen del msj
        % Se han editado los datos de un empleado
