...
% -------- INCLUIDO POR : ARTURO, NAIBI
\MSGdes{MSG7}{Servicios no disponibles por el momento.}
...
% -------- INCLUIDO POR : NAIBI ( CU1 )
\MSGdes{MSG22}{¿Está seguro de eliminar al empleado ''Nombre'' con matrícula: ''Matrícula'' del sistema?}
...
% -------- INCLUIDO POR : Arturo
\MSGdes{MSG37}{Ha ocurrido un error al guardar los datos.}
...
% -------- INCLUIDO POR : Andrew
\MSGdes{MSG47}{El nombre de la Unidad de Aprendizaje ya está registrado. Por favor cámbielo}
