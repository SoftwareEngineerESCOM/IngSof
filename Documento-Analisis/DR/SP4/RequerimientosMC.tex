...
%-----------------------------------------------------Requerimeintos de Usuario-----------------------------------------------------------
        ...
        \FRitem{SP4-U5}{Consultar Programas Académicos }{El usuario Jefe de Innovación Educativa visualiza la información de los Programas Académicos.}{A}{Origen}
        \label{SP4-U5}

        \FRitem{SP4-U6}{Consultar Planes de Estudios }{El usuario Jefe de Innovación Educativa visualiza la información de los Planes de Estudios.}{A}{Origen}
        \label{SP4-U6}
        ...
        \FRitem{SP4-F26}{Login}{El sistema permitirá al usuario ingresar a su cuenta.}{B}{Origen}
        \label{SP4-F26} \\
