% -------------------------------------------------------------------------------------------------------
%-----------------------------CONSULTA DE PLANES DE ESTUDIO Jefe de la División de  Innovación Académica ---------------------------------
% -------------------------------------------------------------------------------------------------------

\section{Gestión de Plan de Estudios}
\subsection{Consulta de Planes de Estudios}
Cuando el Jefe de la División de  Innovación Académica da clic a un programa académico en la sección de \textbf{Gestionar Programas Académicos} aparecerá la siguiente pantalla:
...
Para ello, el Jefe de la División de  Innovación Académica tendrá que seleccionar el Programa Académico que desea consultar en el siguiente componente:
...
Para ello, elJefe de la División de  Innovación Académica tendrá que dar clic en el boton \IUbutton{Lápiz} que esta al lado del Plan de Estudio que desea modificar. Al hacer esto, el sistema redireccionará al usuario a la pantalla de \hyperlink{editarPE}{\textit{Editar Plan de Estudio}}.
...
\end{figure}
 ...
 Si el Jefe de la División de  Innovación Académica da clic en el botón \IUbutton{Cancelar} sin haber concluido la edición del Plan de Estudio:
...
Para cancelar, el usuario debe dar clic en botón  \IUbutton{No}, el mensaje se cerrará y continuaremos en el formulario. Aqui el Jefe de la División de  Innovación Académica puede terminar la edición del Plan de Estudio.\\
...
\begin{itemize}
	...
	Si el Jefe de la División de  Innovación Académica dejo en blanco algún campo del formulario, y posteriormente dio clic en el botón  \IUbutton{Registrar}, el sistema mostrará el siguiente mensaje:
...
Para ello, el Jefe de la División de  Innovación Académica deberá dar clic en el botón \IUbutton{+} en la parte inferior de la pantalla.
...
Si el Jefe de la División de  Innovación Académica en la pantalla de \hyperlink{consultarPE}{\textit{Consultar Planes de Estudios}} dio clic en el botón \IUbutton{+}, aparece la siguiente pantalla:
...
\end{figure}
%\newpage
Si el Jefe de la División de  Innovación Académica da clic en el botón \IUbutton{Cancelar} sin haber concluido el registro del Plan de Estudio:
