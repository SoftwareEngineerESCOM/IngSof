...
Cuando el Jefe de la División de Innovacion Académica da clic a un programa académico en la sección de \textbf{Gestionar Programas Académicos} aparecerá la siguiente pantalla:
...
Para ello, el Jefe de la División de Innovacion Académica tendrá que seleccionar el Programa Académico que desea consultar en el siguiente componente:
...
Para ello, elJefe de la División de Innovacion Académica tendrá que dar clic en el boton \IUbutton{Lápiz} que esta al lado del Plan de Estudio que desea modificar. Al hacer esto, el sistema redireccionará al usuario a la pantalla de \hyperlink{editarPE}{\textit{Editar Plan de Estudio}}.
...
Para cancelar, el usuario debe dar clic en botón  \IUbutton{No}, el mensaje se cerrará y continuaremos en el formulario. aquí el Jefe de la División de Innovacion Académica puede terminar la edición del Plan de Estudio.\\
...
\begin{itemize}
	...
	Si el Jefe de la División de Innovacion Académica dejo en blanco algún campo del formulario, y posteriormente dio clic en el botón  \IUbutton{Registrar}, el sistema mostrará el siguiente mensaje:
	...
	El usuario deberá llenar el o los campos que dejo vacío. Si se continúan dejando campos en blanco y dando clic en el botón  \IUbutton{Registrar}, aparecerá nuevamente el mensaje, hasta que todos los campos sean llenados.
...
Para ello, el Jefe de la División de Innovacion Académica deberá dar clic en el botón \IUbutton{+} en la parte inferior de la pantalla.
...
Si el Jefe de la División de Innovacion Académica en la pantalla de \hyperlink{consultarPE}{\textit{Consultar Planes de Estudios}} dio clic en el botón \IUbutton{+}, aparece la siguiente pantalla:
...
Para cancelar, el usuario debe dar clic en botón  \IUbutton{No}, el mensaje se cerrará y continuaremos en el formulario. aquí el Docente puede terminar la edición del Plan de Estudio.
...
\begin{itemize}
	...
	Significa que ya hay un Plan de Estudio en proceso. Al dar clic en en botón \IUbutton{Aceptar}, el sistema redireccionará al usuario a la pantalla de \hyperlink{registrarPE}{\textit{Registrar Planes de Estudios}}.
