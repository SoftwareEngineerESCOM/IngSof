...
Para ello, el Jefe de Innovación Educativa tiene que dar clic en el boton \IUbutton{Lápiz} que esta al lado del Plan de Estudio que desea modificar. Al hacer esto, el sistema redirecciona al usuario a la pantalla de \hyperlink{editarPE}{\textit{Editar Plan de Estudio}}.
...
\newpage
A continuación, el Jefe de Inovacción Educativa puede modificar todos los campos del Plan de Estudio.
\begin{figure}[!hbtp]
	\centering
...
Para cancelar, el Jefe de Innovación Educativa debe dar clic en botón  \IUbutton{No}, el mensaje se cierra y continuamos en el formulario. Aqui el Jefe de Innovación Educativa puede terminar la edición del Plan de Estudio.\\
...
\begin{itemize}
	...
	\end{figure}
	 ...
	 El Jefe de Innovación Educativa debe llenar el o los campos que dejo vacío. Si se continúan dejando campos en blanco y dando clic en el botón  \IUbutton{Registrar}, aparece nuevamente el mensaje, hasta que todos los campos son llenados.
...
\end{figure}
%\newpage
Si el Jefe de Inovación Educativa da clic en el botón \IUbutton{Cancelar} sin haber concluido el registro del Plan de Estudio:
...
Para cancelar, el Jefe de Innovación Educativa da clic en botón  \IUbutton{No}, el mensaje se cierra y continuamos en el formulario. Aqui el Jefe de Innovación Educativa puede terminar la edición del Plan de Estudio.
