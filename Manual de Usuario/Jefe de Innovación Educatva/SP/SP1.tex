...
\begin{figure}[!hbtp]
	\centering
	\hypertarget{btnreg}{\includegraphics[width=0.7\linewidth]{images/SP1/BotonRegistrar}}
...
Para confirmar, el usuario debe dar clic en el boton ''Sí'', y el Recurso Humano no será modificado.
...
\begin{figure}[!hbtp]
	\centering
	\hypertarget{btnfin}{\includegraphics[width=0.7\linewidth]{images/SP1/BotonFinalizar}}
