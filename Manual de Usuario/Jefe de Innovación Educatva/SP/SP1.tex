...
\chapter{Gestión de Recursos Humanos}
    \section{Consulta de Recursos Humanos}
        ...
        \begin{figure}[!hbtp]
                \centering
                \hypertarget{buscar}{\includegraphics[width=0.7\linewidth]{images/SP1/MSG6}}
        ...
        A continuación, una vez modificados los datos, deberá de dar clic en el botón \IUbutton{Registrar}.
        \begin{figure}[!hbtp]
            \centering
        ...
        \begin{figure}[!hbtp]
                \centering
                \hypertarget{buscar}{\includegraphics[width=0.7\linewidth]{images/SP1/MSG5}}
