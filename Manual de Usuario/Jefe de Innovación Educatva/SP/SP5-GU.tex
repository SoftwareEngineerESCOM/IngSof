...
\chapter{Gestión de Usuarios}
    ...
    \section{Consulta de Usuarios}
        ...
        \begin{enumerate}
            ...
            \item Eliminar Usuarios.
               ...
               % \begin{figure}[!hbtp]
                %	\centering
                %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG22I}}
                %	\caption{Selección de Cargo}
                %	\label{cargo1}
                %\end{figure}
        ...
        \subsection{Posibles errores}
    	  \begin{itemize}	
            ...
            % Imagen del MSG7
             % \begin{figure}[!hbtp]
            %	\centering
            %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG7I}}
            %	\caption{Selección de Cargo}
            %	\label{cargo1}
            %\end{figure}
           		...
           		% \begin{figure}[!hbtp]
           		%	\centering
           		%	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG21I}}
           		%	\caption{Selección de Cargo}
           		%	\label{cargo1}
           		%\end{figure}
    ...
    \newpage
            ...
            % \begin{figure}[!hbtp]
            %	\centering
            %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG29I}}
            %	\caption{Selección de Cargo}
            %	\label{cargo1}
            %\end{figure}    
            ...
            % \begin{figure}[!hbtp]
            %	\centering
            %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG5I}}
            %	\caption{Selección de Cargo}
            %	\label{cargo1}
            %\end{figure}
            ...
            \subsection{Posibles errores} 
                ...
                \begin{itemize}
                    \item Problemas con la conexión o el sistema
                        ...
                        % \begin{figure}[!hbtp]
                        %	\centering
                        %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG25I}}
                        %	\caption{Selección de Cargo}
                        %	\label{cargo1}
                        %\end{figure}
                    ...
                    \item Campos vacíos al momento de agregar un nuevo Usuario
                        ...
                        % \begin{figure}[!hbtp]
                        %	\centering
                        %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG3XI}}
                        %	\caption{Selección de Cargo}
                        %	\label{cargo1}
                        %\end{figure}
                    ...
                    \item El correo ingresado ya existe
                        ...
                        % \begin{figure}[!hbtp]
                        %	\centering
                        %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG36I}}
                        %	\caption{Selección de Cargo}
                        %	\label{cargo1}
                        %\end{figure}
                    ...
                    \item Los campos ingresados no son válidos
                        ...
                        % \begin{figure}[!hbtp]
                        %	\centering
                        %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG35I}}
                        %	\caption{Selección de Cargo}
                        %	\label{cargo1}
                        %\end{figure}
...
\newpage
            ...
            \section{Edición de Usuarios} 
                ...
                \begin{figure}[!hbtp]
                    \centering
                    \hypertarget{modif}{\includegraphics[width=0.7\linewidth]{images/SP5/Editar-Usuario-UA}}
                ...
                % \begin{figure}[!hbtp]
                %	\centering
                %	\hypertarget{cargo1}{\includegraphics[width=0.7\linewidth]{images/SP5/MSG27I}}
                %	\caption{Selección de Cargo}
                %	\label{cargo1}
                %\end{figure}
