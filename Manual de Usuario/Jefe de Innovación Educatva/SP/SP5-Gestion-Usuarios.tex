...
\chapter{Gestión de Usuarios}
    ...
    \section{Consulta de Usuarios}
        ...
        \subsection{Posibles errores}
            ...
            Si al  presionar la opción Gestionar Usuarios no se carga la información de los cargos disponibles para usted se presentará el siguiente mensaje:
    ...
    \newpage
            ...
            Para continuar con el registro, usted tendrá que  dar clic el botón “cancelar”, el mensaje se cerrara y usted continuará en el formulario para terminar el registro.
...
\newpage
            ...
            \section{Edición de Usuarios} 
                ...
                Para confirmar, usted tendrá que dar clic en el botón “Si”, los datos del usuario no será modificados  y regresará a la pantalla \hyperlink{consultarUs}{\textit{Consultar Usuarios}}
            
                Para continuar con la modificación, usted tendrá que  dar clic el botón “No”, el mensaje se cerrara y usted continuará en el formulario para terminar la modificación.
