...
\begin{UseCase}{M-CU16}{Consultar tareas del analista}{Un analista de la DES podrá consultar qué tareas que le fueron asignadas tiene por hacer.}
		...
		\UCitem{Propósito}{Saber qué tareas tiene un analista por hacer, respecto a la revisión de mapas curriculares o unidades de aprendizaje. }
		\UCitem{Entradas}{
          \begin{itemize}
