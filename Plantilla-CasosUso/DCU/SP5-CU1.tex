...
\begin{UseCase}{SP5-CU1}{Iniciar sesión}{Los diversos usuarios podrán ingresar al sistema.}
        ...
        \UCitem{Salidas}{
            \begin{itemize}
                ...
                \item \label{MSGR1} MSGR1. Matrícula y/o contraseña no validas.
                \item \label{MSGR5} MSGR5. Por el momento la página solicitada no esta disponible.
                \item \label{MSGR6} MSGR6. Ha ocurrido un error con la base de datos.
                \item \label{MSGR7} MSGR7. La matrícula ingresada no se encuentra registrada en el sistema.
            \end{itemize}
        }
...
\begin{UCtrayectoria}{Principal}
    ...
    \UCpaso[\UCactor] Presiona el botón \IUbutton{Entrar} de la interfaz de usuario \IUref{IU3}{Inicio de sesión}  [Trayectoria A][Trayectoria C] [Trayectoria D] [Trayectoria E] [Trayectoria F]
\end{UCtrayectoria}
