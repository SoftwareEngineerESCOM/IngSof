\begin{UseCase}{SP5-CU3}{Consultar usuarios}{El  Jefe de División de Innovación Académica podrá visualizar la información de los empleados.}
        ...
        \UCitem{Salidas}{
            \begin{itemize}
                ...
                \item \label{MSGR2} MSG21. No hay usuarios registrados con ese cargo.
                \item \label{MSGR3} MSG22. ¿Seguro de eliminar al empleado ''Nombre'' con matrícula: ''Matrícula'' del sistema?
            \end{itemize}
        }
