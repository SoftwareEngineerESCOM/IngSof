\chapter{Procesos}
\begin{BPMN}{PROC-01}{Creación de un Programa Académico}{Surge la iniciativa crear o re diseñar un programa académico la unidad académica notifica a la DES que existe una propuesta, a su vez la DES se encarga de supervisar a la unidad académica en durante este proceso, lo que incluye la revisión del plan de estudios, mapa curricular, unidades de aprendizaje y la gestión de los documentos correspondientes para su aprobación. }
    ...
    \PCitem{Frecuencia}{Cada que existe un propuesta de creación o re diseño}
