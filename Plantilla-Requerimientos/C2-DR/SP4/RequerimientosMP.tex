...
%-----------------------------------------------------Requerimeintos de Usuario-----------------------------------------------------------
        ...
        \FRitem{SP1-U14}{Modificar información de usuarios}{El usuario (Jefe de Innovación Educativa) modifica la información general de los usuarios integrantes de la Unidad Académica a la que pertenece.}{B}{Origen}
        \label{SP1-U14}

        \FRitem{SP1-U15}{Eliminar Usuarios de la Unidad Académica}{El usuario (Jefe de Innovación Educativa) elimina a cualquier usuario integrante de la Unidad Académica a la que pertenece.}{B}{Origen}
        \label{SP1-U15}
