...
\begin{table}[htbp!]
    \begin{requerimientos}
        ...
        \FRitem{RM4}{Guardar Avances del Mapa Curricular}{El sistema debe permitirle al usuario Docente guardar las Unidades de Aprendizaje que este vaya registrando.}{M}{Origen}
        \label{RM4}
