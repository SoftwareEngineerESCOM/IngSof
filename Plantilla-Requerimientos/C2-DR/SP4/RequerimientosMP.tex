...
%-----------------------------------------------------Requerimeintos de Usuario-----------------------------------------------------------
        ...
        \FRitem{SP1-U16}{Modificar datos por Docente}(El usuario (Docente) modifica los datos de las Unidades de Aprendizaje).}{B}{Origen}
        \label{SP1-U16}
                
        \FRitem{SP1-U17}{Eliminar datos  por Docente}{El usuario (Docente) elimina los datos de las Unidades de Aprendizaje).}{B}{Origen}
        \label{SP1-U17}
                \FRitem{SP1-U18}{Guardar Datos  por Docente}{El usuario (Docente) guarda los datos de las Unidades de Aprendizaje).}{B}{Origen}
        \label{SP1-U18}
