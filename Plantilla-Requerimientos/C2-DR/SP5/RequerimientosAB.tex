...
\begin{table}[htbp!]
	\begin{requerimientos}
		...
		\FRitem{VMP-15}{Realizar notas}{El sistema permitirá a la JDIC redactar correcciones parciales del mapa curricular en un archivo en Word, y al final generar un PDF con todas las correcciones finales, una vez aprobado éste.}{B}{}
	\end{requerimientos}
